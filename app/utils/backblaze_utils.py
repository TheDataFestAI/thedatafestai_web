...
def download_file_from_backblaze(file_id, bucket_name="tdf-app-bucket"):
    ...
    bucket = b2_api.get_bucket_by_name(bucket_name)
    # file_version = bucket.get_file_version(file_name)
    ...
    # b2_api.download_file_by_id(file_id, download_dest)
    file_bytes = download_dest.get_bytes_written()
    # print(downloaded_file)
    # print(f"downloaded_file:\n{dir(downloaded_file)}")
    yield BytesIO(file_bytes)